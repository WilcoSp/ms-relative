![License](https://img.shields.io/npm/l/ms-relative) [![npm](https://img.shields.io/npm/v/ms-relative?cv=0.0.4)](https://www.npmjs.com/package/ms-relative)
[![JSR](https://jsr.io/badges/@wilcosp/ms-relative?cv=0.0.4)](https://jsr.io/@wilcosp/ms-relative)
[![Vitest](https://github.com/wilcosp/ms-relative/actions/workflows/vitest.yml/badge.svg?cv=0.0.4)](https://github.com/wilcosp/ms-relative/actions/workflows/test.yml)
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/ms-relative?color=green&cv=0.0.4)](https://bundlephobia.com/package/ms-relative)
[![GitHub Repo stars](https://img.shields.io/github/stars/wilcosp/ms-relative?style=flat&logo=github&color=green&cv=0.0.4)](https://github.com/WilcoSp/ms-relative)
...
-   Jsdelivr: https://cdn.jsdelivr.net/npm/ms-relative@0.0.4
-   Esm.sh: https://esm.sh/ms-relative@0.0.4
-   Unpkg: https://unpkg.com/ms-relative@0.0.4
...
// or
import { second, minute, hour, day, week, year  } from `https://cdn.jsdelivr.net/npm/ms-relative@0.0.4
...
// or
import { format, day, second, year, week } from `https://cdn.jsdelivr.net/npm/ms-relative@0.0.4` // cdn (can also be esm.sh or unpkg)
...
import { format, day, second, year, week } from "@wilcosp/ms-relative" // for jsr
// or
import { format, day, second, year, week } from `https://esm.sh/ms-relative@0.0.4` // cdn (can also be jsdelivr or unpkg)
...
// or
import { parseToMs } from `https://esm.sh/ms-relative@0.0.4` // cdn (can also be jsdelivr or unpkg)
...
// or
import { msToMap, msToObject, year, minute } from "https://unpkg.com/ms-relative@0.0.4"; //cdn, can also be used with jsdelivr or esn.sh
